 ...
 */
	...
	'loginerror' => "Your username/password were wrong.",
	...
	'logout' => "Sign Out",
	'logoutok' => "You have signed out! Byeeee......",
 ...
 */
	...
	'error:404:title' => 'The Page you wanted to see doesn\'t exist. That is all we know...(weally sowwy) ',
	'error:404:content' => 'You tried to access a page which doesn\'t exist, try again!',
 ...
 */
	...
	'widgets:add' => 'Add Live Cards',
	'widgets:add:description' => "Click on any Live Card button below to add it to the page.",
	'widgets:panel:close' => "Close Live Cards Panel",
	'widgets:position:fixed' => '(Fixed position on page)',
	'widget:unavailable' => 'You have already added this Card',
	'widget:numbertodisplay' => 'Number of items to display',

	'widget:delete' => 'Remove %s',
	'widget:edit' => 'Customize this Live Card',

	'widgets' => "Live Cards",
	'widget' => "Card",
	'item:object:widget' => "Live Cards",
	'widgets:save:success' => "The card was successfully saved.",
	'widgets:save:failure' => "We could not save your card.",
	'widgets:add:success' => "The card was successfully added.",
	'widgets:add:failure' => "We could not add your card.",
	'widgets:move:failure' => "We could not store the new card position.",
	'widgets:remove:failure' => "Unable to remove this card",
 ...
 */
	...
	'friends' => "Circles",
	'friends:yours' => "People in your Circle",
	'friends:owned' => "My Circle",
	'friend:add' => "Add to My Circles",
	'friend:remove' => "Remove from My Circles",

	'friends:add:successful' => "You have successfully added %s to your Circles.",
	'friends:add:failure' => "We couldn't add %s to your Circles. Please try again",

	'friends:remove:successful' => "You have successfully removed %s from your Circles.",
	'friends:remove:failure' => "We couldn't remove %s from your Circles",

	'friends:none' => "No One in the Circle.",
	'friends:none:you' => "You don't have anyone in your Circle yet.",

	'friends:none:found' => "Nobody was found in your Circle.",

	'friends:of:none' => "Nobody has added this user to their Circles yet.",
	'friends:of:none:you' => "Nobody has added you to their Circles yet. Start adding content and fill in your profile to let people find you!",

	'friends:of:owned' => "People who have added %s to their Circles",

	'friends:of' => "People who put you in their Circle",
	'friends:collections' => "Circles Kollection",
	'collections:add' => "New Kollection",
	'friends:collections:add' => "New Circles Kollection",
	'friends:addfriends' => "Select from People in your Circle",
	'friends:collectionname' => "Kollection Name",
	'friends:collectionfriends' => "People from my Circle in this Kollection",
	'friends:collectionedit' => "Edit this Kollection",
	'friends:nocollections' => "You do not have any Kollections yet.",
	'friends:collectiondeleted' => "Your Kollection has been deleted.",
	'friends:collectiondeletefailed' => "We were unable to delete the Kollection. Either you don't have permission, or some other problem has occurred.",
	'friends:collectionadded' => "Your Kollection was successfully created",
	'friends:nocollectionname' => "You need to give your collection a name before it can be created.",
	'friends:collections:members' => "People from my Circle in this Kollection",
	'friends:collections:edit' => "Edit Kollection",
	'friends:collections:edited' => "Saved Kollection",
	'friends:collection:edit_failed' => 'Could not save Kollection.',

	'friendspicker:chararray' => 'ABCDEFGHIJKLMNOPQRSTUVWXYZ',

	'avatar' => 'Profile Picture',
	'avatar:noaccess' => "You're not allowed to edit this user's profile picture",
	'avatar:create' => 'Add Profile Picture',
	'avatar:edit' => 'Edit Profile Picture',
	'avatar:preview' => 'Preview',
	'avatar:upload' => 'Upload Profile Picture',
	'avatar:current' => 'Current Profile Picture',
	'avatar:remove' => 'Reset to Default',
	'avatar:crop:title' => 'Profile Picture Cropper',
	...
	'avatar:create:instructions' => 'Click and drag a square below to match how you want your profile picture cropped. A preview will appear in the box on the right. When you are happy with the preview, click \'Add Profile Picture\'. This cropped version will be used throughout the site as your Profile Picture.',
	'avatar:upload:success' => 'Profile Picture Changed!',
	'avatar:upload:fail' => 'Profile Picture Upload Failed',
	'avatar:resize:fail' => 'Resize of the Profile Picture failed',
	'avatar:crop:success' => 'You have cropped your Profile Picture',
	'avatar:crop:fail' => 'Profile Picture cropping failed',
	'avatar:remove:success' => 'Profile Picture Reset',
	'avatar:remove:fail' => 'Profile Picture remove failed',
 ...
 */
	'river' => "Wall Card",
	'river:friend:user:default' => "%s has added %s to their Circle",
	...
	'river:none' => 'No Activity on the Wall',
	'river:update' => 'Update for %s',
	'river:delete' => 'Remove this Wall Card',
	'river:delete:success' => 'Wall Card deleted!',
	'river:delete:fail' => 'Wall Card could not be deleted!',
	'river:subject:invalid_subject' => 'Invalid user',
	'activity:owner' => 'View Wall',

	'river:widget:title' => "Wall",
	'river:widget:description' => "Latest Wall Cards",
	'river:widget:type' => "Type of Cards",
	'river:widgets:friends' => 'Wall Cards of People in My Circle',
	'river:widgets:all' => 'Wall Cards of Everyone',
 ...
 */
	...
	'user:persistent' => 'Don\'t Forget Me',

	'walled_garden:welcome' => '',
...
three sections:
	...
	'admin:widget:control_panel' => 'Re-New',
 ...
 */
	...
	'admin:plugins:activate_all' => 'Turn All On',
	'admin:plugins:deactivate_all' => 'Turn All Off',
	'admin:plugins:activate' => 'On',
	'admin:plugins:deactivate' => 'Off',
 ...
 */
	...
	'river:all' => 'Everyone\'s Wall Card',
	'river:mine' => 'My Wall Cards',
	'river:owner' => 'Wall Cards of %s',
	'river:friends' => 'Wall Cards from People in My Circle',
	'river:select' => 'Show %s',
	'river:comments:more' => '+%u more',
	'river:comments:all' => 'View all Comments(%u)',
	'river:generic_comment' => 'commented on %s %s',

	'friends:widget:description' => "Shows People from your Circle.",
	'friends:num_display' => "Number of People from my Circle to show",
 ...
 */
	...
	'content' => "content",
	'content:latest' => 'Latest Wall Cards',
 ...
 */
	...
	'actiongatekeeper:missingfields' => 'Umm... Try to Fill Something in (and Please Don\'t Click Refresh while logging in!) ',
 ...
 */
	...
	"zu" => "Zulu",
	   ...
	   'lastlogin:online' => '<em><span style="color:#4caf50; font-weight:500;">Now</span></em>',
        'lastlogin:lastlogin' => '<span style="font-weight:500;">Active</span>',
        'lastlogin:today' => '<em><span style="color:#009688; font-weight:500;">a couple of minutes ago</span></em>',
        'lastlogin:hour' => '<em><span style="color:#FFC107; font-weight:500;">about an hour ago...</span></em>',
        'lastlogin:never' => '<em><span style="color:#FF4336; font-weight:500;">many weeks ago...</span></em>',
        'lastlogin:joindate' => 'Join date',
        'lastlogin:guid' => 'User\'s ID',

        'lastlogin:settings:lastlogin_info' => 'Hi! This is the Last Login Setting of the Plugin.',
        'lastlogin:settings:lastlogin_time' => 'Should it display the last active time of the user? ',
        'lastlogin:settings:registered_time' => 'Should it display the join date of a user? ',
        'lastlogin:settings:guid' => 'Should it display the user\'s ID? ',
        'lastlogin:settings:no' => 'No',
        'lastlogin:settings:yes' => 'Yes',
        'lastlogin:settings:admin' => 'For Administrators Only',
        'lastlogin:settings:all' => 'For EveryOne'
);
