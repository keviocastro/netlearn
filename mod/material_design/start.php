...
function lastlogin_init() {
    elgg_extend_view('css/elgg','material_design/css');
    elgg_extend_view('icon/user/default','material_design/profile_extend',600);
}
...
function aalborg_theme_setup_head($hook, $type, $data) {
	...
	$data['links']['apple-touch-icon'] = array(
		...
		'href' => elgg_normalize_url('mod/material_design/graphics/homescreen.png'),
	);
