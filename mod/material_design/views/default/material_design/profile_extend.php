...
if ((elgg_get_context() == "profile") && ($vars['size'] == "large")) {
    ...
    if ((elgg_get_plugin_setting('lastlogin_visibility', 'material_design') == "all") || (elgg_get_plugin_setting('lastlogin_visibility', 'material_design') == "admin") && (elgg_is_admin_logged_in())) {
    ...
    if ((elgg_get_plugin_setting('registered_visibility', 'material_design') == "all") || (elgg_get_plugin_setting('registered_visibility', 'material_design') == "admin") && (elgg_is_admin_logged_in())) {
        $time_created = $vars['entity']->time_created;
        $contents .=  elgg_echo('lastlogin:joindate').": ".date("Y/n/j", $time_created)."<br>";
        $add_it = true;
    }

    if ((elgg_get_plugin_setting('guid_visibility', 'material_design') == "yes") && (elgg_is_admin_logged_in())) {
