...
.elgg-pagination {
	...
	color:white;	font-family:Roboto, "Roboto Condensed", Arial, Helvetica;
font-weight:400;
}
.elgg-pagination li {
	display: inline;
...
.elgg-pagination a:hover {
	color: #978E8E;	font-family:Roboto, "Roboto Condensed", Arial, Helvetica;
font-weight:400;
	text-decoration: none;
}
.elgg-pagination .elgg-state-disabled span {
	color: #C7C2C2;	font-family:Roboto, "Roboto Condensed", Arial, Helvetica;
font-weight:400;
}
